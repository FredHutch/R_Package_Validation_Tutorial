...
###### Action
# instantiate
# suppress opening new rstudio session
...
###### Action
# Create a requirement file "req1.md"
...
#
#
# 2. Compile the report using valtools::vt_*
...
# 4. Render the requirement report to pdf using valtools::vt_*
